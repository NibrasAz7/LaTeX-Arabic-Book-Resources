...
├── examples/
│   ├── ch01/          # الفصل 1: أساسيات LaTeX (3 أمثلة)
│   ├── ch02/          # الفصل 2: التنضيد الطباعي (12 مثال)
│   ├── ch03/          # الفصل 3: الأشكال والمخططات (14 مثال)
│   ├── ch04/          # الفصل 4: الجداول (6 أمثلة)
│   ├── ch05/          # الفصل 5: الرياضيات (8 أمثلة)
│   ├── ch06/          # الفصل 6: المراجع (7 أمثلة)
│   ├── ch07/          # الفصل 7: بنية المستند (10 أمثلة)
│   ├── ch08/          # الفصل 8: العروض التقديمية (14 مثال)
│   ├── ch09/          # الفصل 9: سير العمل (6 أمثلة)
│   ├── ch10/          # الفصل 10: التنضيد العربي (13 مثال)
│   ├── ch11/          # الفصل 11: النشر (11 مثال)
│   └── appendixA/     # الملحق أ: تمارين (21 تمرين)
...
|-------|---------|-------------|
| 1 | أساسيات LaTeX | 3 |
| 2 | التنضيد الطباعي والخطوط متعددة اللغات | 12 |
| 3 | الأشكال والمخططات والتواصل البصري | 14 |
| 4 | الجداول وعرض البيانات | 6 |
| 5 | تنضيد الرياضيات | 8 |
| 6 | المراجع وإدارة الاستشهادات | 7 |
| 7 | بنية المستند والإحالات المتقاطعة | 10 |
| 8 | العروض التقديمية بـ Beamer | 14 |
| 9 | سير العمل الحديث | 6 |
| 10 | التنضيد العربي والكتابة من اليمين إلى اليسار | 13 |
| 11 | سير عمل النشر والتقديم للمجلات | 11 |
| أ | التمارين والمختبرات | 21 |
| **المجموع** | | **125** |
